...
enum CoreStrings {
    static let table: [String: LText] = [
        ...
        "server.url": LText(de: "Adresse, z. B. http://ark.atomi23.de:7792", en: "Address, e.g. http://ark.atomi23.de:7792"),
        ...
        "server.testFailATS": LText(de: "Öffentliche Server brauchen HTTPS — außer http://ark.atomi23.de (AMP). Sonst ist http:// nur für private LAN-, Loopback- oder Tailscale-Adressen erlaubt; starte den LAN-Server zusätzlich mit ALLOW_HTTP_PRIVATE_LAN=1.",
                                    en: "Public servers require HTTPS — except http://ark.atomi23.de (AMP). Otherwise http:// is allowed only for private LAN, loopback, or Tailscale addresses; also start the LAN server with ALLOW_HTTP_PRIVATE_LAN=1."),
        "server.invalidURL": LText(de: "Das sieht nicht wie eine gültige Adresse aus", en: "That doesn't look like a valid address"),
        "server.buildBadge": LText(de: "App-Build {version} · HTTPS, AMP-HTTP für ark.atomi23.de", en: "App build {version} · HTTPS, AMP HTTP for ark.atomi23.de"),
        ...
        "server.hint": LText(de: "Öffentlich: https:// verwenden. Ausnahme: http://ark.atomi23.de:7792 (euer AMP-Server). Privat im LAN/Tailscale ist http:// möglich, wenn der Server ausdrücklich mit ALLOW_HTTP_PRIVATE_LAN=1 gestartet wurde.",
                             en: "Public server: use https://. Exception: http://ark.atomi23.de:7792 (your AMP server). Private LAN/Tailscale may use http:// when the server was explicitly started with ALLOW_HTTP_PRIVATE_LAN=1."),
